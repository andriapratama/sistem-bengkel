...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/admin/units/add', [UnitController::class, 'create'])->name('units.create');
    Route::get('/admin/units/{unit}/edit', [UnitController::class, "edit"])->name('units.edit');
    Route::put('/units/{unit}', [UnitController::class, "update"])->name('units.update');
    Route::delete('/units/{unit}', [UnitController::class, "destroy"])->name('units.destroy');

    Route::get('/admin/categories', [CategoryController::class, 'index'])->name('categories.index');
    Route::post('/categories', [CategoryController::class, 'store'])->name('categories.store');
    Route::get('/admin/categories/add', [CategoryController::class, 'create'])->name('categories.create');
    ...
    Route::get('/admin/products/{product}/edit-image', [ProductController::class, "editImage"])->name('products.edit-image');
    ...
    Route::get('/admin/vehicle-brands', [VehicleBrandController::class, 'index'])->name('vehicle-brands.index');
    Route::post('/vehicle-brands', [VehicleBrandController::class, 'store'])->name('vehicle-brands.store');
    Route::get('/admin/vehicle-brands/add', [VehicleBrandController::class, 'create'])->name('vehicle-brands.create');
    ...
    Route::get('/admin/vehicle-variants/{vehicleVariant}/edit', [VehicleVariantController::class, "edit"])->name('vehicle-variants.edit');
